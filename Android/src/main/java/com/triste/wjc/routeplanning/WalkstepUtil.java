...
/**
 * Created by Triste on 2016/10/31.
 */
public class WalkstepUtil {
    ...
    private static WalkstepUtil Walkstep=null;
    private SensorManager mSensorManager=null;
    private boolean isStart = false;

    private WalkstepUtil(){

    }

    public static WalkstepUtil getInstance(SensorManager a){
        if(Walkstep==null){
            Walkstep = new WalkstepUtil();
        }
        Walkstep.isStart = false;
        Walkstep.mSensorManager = a;
        Walkstep.initWalkstep();
        return Walkstep;
    }

    private void initWalkstep(){
        stepCount=0;
        ...
        mSensorManager.registerListener(listener, acceleromererSensor, SensorManager.SENSOR_DELAY_GAME);
            ...
            if (DetectorPeak(values, gravityOld)) {
                ...
                if (timeOfNow - timeOfLastPeak >= 250
                    ...
                    * */
                    ...
                    //textView_walkStep.setText(""+(++stepCount)+"步");
                    if(isStart)
                        ++stepCount;
                    Log.d("wjctag", ""+stepCount);
                }
                if (timeOfNow - timeOfLastPeak >= 250
